...
export declare enum AdobeAppName {
    Animate = "animate",
    Photoshop = "photoshop",
...
export declare enum AdobeAppScriptFileType {
    Jsfl = "jsfl",
    Jsx = "jsx"
}
export declare type AdobeProcessOptions = {
    timeout?: number;
...
export declare type NewDocumentOptions = Options & {
    title?: string;
    width?: number;
    height?: number;
};
export declare type AdobeAppConfig = {
    name: AdobeAppName;
    path: string;
...
export declare enum AdobeAppEvent {
    OpenApp = "open_app",
    CloseApp = "close_app",
